package com.kaua.corebank.domain.utils;

import com.kaua.corebank.domain.validation.AssertionConcern;
...
public record Period(
    ...
    public Period {
        ...
        this.assertArgumentTrue(start.compareTo(end) < 0, "start", "should be before end");
    }
